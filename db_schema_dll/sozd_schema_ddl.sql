-- DDL схемы sozd
-- Сгенерировано: 2025-12-25 21:26:45.506153

CREATE SCHEMA IF NOT EXISTS sozd;
...
CREATE INDEX aggregate_data_law_name_idx ON sozd.aggregate_data USING btree (law_name);
CREATE INDEX aggregate_data_law_reg_date_idx ON sozd.aggregate_data USING btree (law_reg_date);
CREATE INDEX aggregate_data_law_status_idx ON sozd.aggregate_data USING btree (law_status);
CREATE INDEX aggregate_data_law_name_comment_idx ON sozd.aggregate_data USING btree (law_name_comment);
CREATE UNIQUE INDEX "0cd82e84bfa4a5253561b33ab4485922" ON sozd.aggregate_data USING btree (law_id);
...
CREATE UNIQUE INDEX "2df82ce88a627d6c5966e31a492fc11c" ON sozd.dim_law USING btree (law_id);
...
CREATE UNIQUE INDEX dim_law_status_subject_subject_idx ON sozd.dim_law_status_subject USING btree (subject);
...
CREATE UNIQUE INDEX explanations_law_law_id_idx ON sozd.explanations_law USING btree (law_id);
CREATE INDEX trgm_name_idx ON sozd.explanations_law USING gin (main_idea gin_trgm_ops);
...
CREATE INDEX c7eaf516b0380f7d0e3442bf708339d8 ON sozd.fact_transactions USING btree (law_id);
...
CREATE UNIQUE INDEX for_monitoring_law_law_id_idx ON sozd.for_monitoring_law USING btree (law_id);
...
CREATE UNIQUE INDEX his_absent_laws_law_id_idx ON sozd.his_absent_laws USING btree (law_id);
...
CREATE UNIQUE INDEX his_amendments_id_amendment_idx ON sozd.his_amendments USING btree (id_amendment);
...
CREATE UNIQUE INDEX his_openai_cost_date_idx ON sozd.his_openai_cost USING btree (date);
...
CREATE UNIQUE INDEX his_transcript_full_date_idx ON sozd.his_transcript_full USING btree (date);
...
CREATE INDEX his_transcript_law_law_id_idx ON sozd.his_transcript_law USING btree (law_id);
CREATE INDEX his_transcript_law_number_idx ON sozd.his_transcript_law USING btree (number);
...
CREATE INDEX his_votes_law_id_idx ON sozd.his_votes USING btree (law_id);
CREATE INDEX his_votes_number_idx ON sozd.his_votes USING btree (number);
...
CREATE INDEX his_votes_deputies_code_idx ON sozd.his_votes_deputies USING btree (code);
CREATE INDEX his_votes_deputies_number_idx ON sozd.his_votes_deputies USING btree (number);
...
CREATE INDEX law_files_law_id_idx ON sozd.law_files USING btree (law_id);
CREATE INDEX law_files_filename_idx ON sozd.law_files USING btree (filename);
CREATE INDEX law_files_at_date_idx ON sozd.law_files USING btree (at_date);
CREATE UNIQUE INDEX law_files_law_id_comment_filename_url_idx ON sozd.law_files USING btree (law_id, comment, filename, url_doc);
...
CREATE INDEX logs_at_date_time_idx ON sozd.logs USING btree (at_date_time);
...
CREATE UNIQUE INDEX meta_data_key_idx ON sozd.meta_data USING btree (key, value, law_id, law_status, law_name, law_name_comment);
...
CREATE UNIQUE INDEX nsi_classes_idx ON sozd.nsi_classes USING btree (name);
...
CREATE UNIQUE INDEX nsi_convocations_idx ON sozd.nsi_convocations USING btree (number);
...
CREATE UNIQUE INDEX nsi_degrees_idx ON sozd.nsi_degrees USING btree (sh_name);
...
CREATE UNIQUE INDEX nsi_deputy_factions_idx ON sozd.nsi_deputy_factions USING btree (faction_id, faction_name, start_date, stop_date);
...
CREATE UNIQUE INDEX nsi_educations_idx ON sozd.nsi_educations USING btree (sh_name);
...
CREATE UNIQUE INDEX nsi_factions_idx ON sozd.nsi_factions USING btree (faction_id);
...
CREATE UNIQUE INDEX nsi_federal_organs_idx ON sozd.nsi_federal_organs USING btree (name);
...
CREATE UNIQUE INDEX nsi_function_idx ON sozd.nsi_function USING btree (sh_name);
...
CREATE UNIQUE INDEX nsi_guests_idx ON sozd.nsi_guests USING btree (sh_name);
...
CREATE UNIQUE INDEX nsi_instances_idx ON sozd.nsi_instances USING btree (sh_name);
...
CREATE UNIQUE INDEX nsi_law_status_idx ON sozd.nsi_law_status USING btree (code);
...
CREATE UNIQUE INDEX nsi_parser_functions_idx ON sozd.nsi_parser_functions USING btree (sh_name);
...
CREATE UNIQUE INDEX nsi_ranks_idx ON sozd.nsi_ranks USING btree (sh_name);
...
CREATE UNIQUE INDEX nsi_regions_idx ON sozd.nsi_regions USING btree (sh_name);
...
CREATE UNIQUE INDEX nsi_stages_idx ON sozd.nsi_stages USING btree (sh_name);
...
CREATE UNIQUE INDEX nsi_topics_idx ON sozd.nsi_topics USING btree (name);
...
CREATE INDEX rel_amendments_authors_authors_authors_id_idx ON sozd.rel_amendments_authors_authors USING btree (authors_id);
CREATE UNIQUE INDEX rel_amendments_authors_authors_idx ON sozd.rel_amendments_authors_authors USING btree (amendments_id, authors_id);
...
CREATE UNIQUE INDEX rel_deputies_degrees_degree_idx ON sozd.rel_deputies_degrees_degree USING btree (deputies_id, degrees_id);
...
CREATE UNIQUE INDEX rel_deputies_educations_education_idx ON sozd.rel_deputies_educations_education USING btree (deputies_id, educations_id);
...
CREATE UNIQUE INDEX rel_deputies_function_function_idx ON sozd.rel_deputies_function_function USING btree (deputies_id, function_id);
...
CREATE UNIQUE INDEX rel_deputies_ranks_rank_idx ON sozd.rel_deputies_ranks_rank USING btree (deputies_id, ranks_id);
...
CREATE UNIQUE INDEX rel_deputies_regions_region_idx ON sozd.rel_deputies_regions_region USING btree (deputies_id, regions_id);
...
CREATE UNIQUE INDEX rel_law_themes_list_laws_themes_laws_idx ON sozd.rel_law_themes_list_laws_themes_laws USING btree (law_themes_id, list_laws_themes_id);
...
CREATE UNIQUE INDEX rel_stages_phases_phase_idx ON sozd.rel_stages_phases_phase USING btree (stages_id, phases_id);
...
CREATE UNIQUE INDEX trans_data_key_idx ON sozd.trans_data USING btree (key, law_id, value);
CREATE INDEX trans_data_law_id_idx ON sozd.trans_data USING btree (law_id);
...
CREATE UNIQUE INDEX trans_key_for_monitoring_key_idx ON sozd.trans_key_for_monitoring USING btree (key);
...
-- Внешние ключи
ALTER TABLE sozd.explanations_law ADD CONSTRAINT explanations_law_fk FOREIGN KEY (law_id) REFERENCES sozd.url_id (law_id);
ALTER TABLE sozd.for_monitoring_law ADD CONSTRAINT for_monitoring_law_fk FOREIGN KEY (law_id) REFERENCES sozd.url_id (law_id);
ALTER TABLE sozd.his_absent_laws ADD CONSTRAINT his_absent_laws_fk FOREIGN KEY (law_id) REFERENCES sozd.url_id (law_id);
ALTER TABLE sozd.his_guests_page ADD CONSTRAINT his_guests_page_fk FOREIGN KEY (guests_id) REFERENCES sozd.nsi_guests (id);
ALTER TABLE sozd.his_law_name ADD CONSTRAINT his_law_name_fk FOREIGN KEY (law_id) REFERENCES sozd.url_id (law_id);
ALTER TABLE sozd.his_laws ADD CONSTRAINT his_laws_fk FOREIGN KEY (law_id) REFERENCES sozd.url_id (law_id);
ALTER TABLE sozd.his_search_counts ADD CONSTRAINT his_search_counts_fk FOREIGN KEY (search_id) REFERENCES sozd.nsi_search (id);
ALTER TABLE sozd.his_trans_data ADD CONSTRAINT his_trans_data_fk FOREIGN KEY (law_id) REFERENCES sozd.url_id (law_id);
ALTER TABLE sozd.his_transcript_law ADD CONSTRAINT his_transcript_law_fk FOREIGN KEY (law_id) REFERENCES sozd.url_id (law_id);
ALTER TABLE sozd.his_votes ADD CONSTRAINT his_votes_fk FOREIGN KEY (law_id) REFERENCES sozd.url_id (law_id);
ALTER TABLE sozd.law_files ADD CONSTRAINT law_files_fk FOREIGN KEY (law_id) REFERENCES sozd.url_id (law_id);
ALTER TABLE sozd.link_guests ADD CONSTRAINT sozd_link_guests_fk2 FOREIGN KEY (id) REFERENCES sozd.nsi_guests (id);
ALTER TABLE sozd.link_search ADD CONSTRAINT sozd_link_search_fk2 FOREIGN KEY (id) REFERENCES sozd.nsi_search (id);
ALTER TABLE sozd.nsi_acts ADD CONSTRAINT sozd_nsi_acts_fk1 FOREIGN KEY (law_type) REFERENCES sozd.nsi_law_types (id);
ALTER TABLE sozd.nsi_deputy_factions ADD CONSTRAINT sozd_nsi_deputy_factions_fk1 FOREIGN KEY (deputy) REFERENCES sozd.nsi_deputies (id);
ALTER TABLE sozd.nsi_factions ADD CONSTRAINT sozd_nsi_factions_fk1 FOREIGN KEY (convocation_number) REFERENCES sozd.nsi_convocations (number);
ALTER TABLE sozd.nsi_functions_params ADD CONSTRAINT sozd_nsi_functions_params_fk1 FOREIGN KEY (function) REFERENCES sozd.nsi_parser_functions (id);
ALTER TABLE sozd.nsi_phases ADD CONSTRAINT sozd_nsi_phases_fk1 FOREIGN KEY (instance) REFERENCES sozd.nsi_instances (id);
ALTER TABLE sozd.nsi_rss_history ADD CONSTRAINT sozd_nsi_rss_history_fk1 FOREIGN KEY (act) REFERENCES sozd.nsi_acts (id);
ALTER TABLE sozd.nsi_sessions ADD CONSTRAINT sozd_nsi_sessions_fk1 FOREIGN KEY (convocation) REFERENCES sozd.nsi_convocations (id);
ALTER TABLE sozd.nsi_work_list_laws ADD CONSTRAINT sozd_nsi_work_list_laws_fk1 FOREIGN KEY (theme) REFERENCES sozd.nsi_law_themes (id);
ALTER TABLE sozd.rel_amendments_authors_authors ADD CONSTRAINT amendments_fk FOREIGN KEY (amendments_id) REFERENCES sozd.nsi_amendments (id);
ALTER TABLE sozd.rel_amendments_authors_authors ADD CONSTRAINT amendments_fk_1 FOREIGN KEY (authors_id) REFERENCES sozd.nsi_authors (id);
ALTER TABLE sozd.rel_deputies_degrees_degree ADD CONSTRAINT deputies_fk FOREIGN KEY (deputies_id) REFERENCES sozd.nsi_deputies (id);
ALTER TABLE sozd.rel_deputies_degrees_degree ADD CONSTRAINT deputies_fk_1 FOREIGN KEY (degrees_id, educations_id, function_id, ranks_id, regions_id) REFERENCES sozd.nsi_degrees (id);
ALTER TABLE sozd.rel_deputies_degrees_degree ADD CONSTRAINT deputies_fk_1 FOREIGN KEY (degrees_id, educations_id, function_id, ranks_id, regions_id) REFERENCES sozd.nsi_educations (id);
ALTER TABLE sozd.rel_deputies_degrees_degree ADD CONSTRAINT deputies_fk_1 FOREIGN KEY (degrees_id, educations_id, function_id, ranks_id, regions_id) REFERENCES sozd.nsi_function (id);
ALTER TABLE sozd.rel_deputies_degrees_degree ADD CONSTRAINT deputies_fk_1 FOREIGN KEY (degrees_id, educations_id, function_id, ranks_id, regions_id) REFERENCES sozd.nsi_ranks (id);
ALTER TABLE sozd.rel_deputies_degrees_degree ADD CONSTRAINT deputies_fk_1 FOREIGN KEY (degrees_id, educations_id, function_id, ranks_id, regions_id) REFERENCES sozd.nsi_regions (id);
ALTER TABLE sozd.rel_deputies_educations_education ADD CONSTRAINT deputies_fk FOREIGN KEY (deputies_id) REFERENCES sozd.nsi_deputies (id);
ALTER TABLE sozd.rel_deputies_educations_education ADD CONSTRAINT deputies_fk_1 FOREIGN KEY (degrees_id, educations_id, function_id, ranks_id, regions_id) REFERENCES sozd.nsi_degrees (id);
ALTER TABLE sozd.rel_deputies_educations_education ADD CONSTRAINT deputies_fk_1 FOREIGN KEY (degrees_id, educations_id, function_id, ranks_id, regions_id) REFERENCES sozd.nsi_educations (id);
ALTER TABLE sozd.rel_deputies_educations_education ADD CONSTRAINT deputies_fk_1 FOREIGN KEY (degrees_id, educations_id, function_id, ranks_id, regions_id) REFERENCES sozd.nsi_function (id);
ALTER TABLE sozd.rel_deputies_educations_education ADD CONSTRAINT deputies_fk_1 FOREIGN KEY (degrees_id, educations_id, function_id, ranks_id, regions_id) REFERENCES sozd.nsi_ranks (id);
ALTER TABLE sozd.rel_deputies_educations_education ADD CONSTRAINT deputies_fk_1 FOREIGN KEY (degrees_id, educations_id, function_id, ranks_id, regions_id) REFERENCES sozd.nsi_regions (id);
ALTER TABLE sozd.rel_deputies_function_function ADD CONSTRAINT deputies_fk FOREIGN KEY (deputies_id) REFERENCES sozd.nsi_deputies (id);
ALTER TABLE sozd.rel_deputies_function_function ADD CONSTRAINT deputies_fk_1 FOREIGN KEY (degrees_id, educations_id, function_id, ranks_id, regions_id) REFERENCES sozd.nsi_degrees (id);
ALTER TABLE sozd.rel_deputies_function_function ADD CONSTRAINT deputies_fk_1 FOREIGN KEY (degrees_id, educations_id, function_id, ranks_id, regions_id) REFERENCES sozd.nsi_educations (id);
ALTER TABLE sozd.rel_deputies_function_function ADD CONSTRAINT deputies_fk_1 FOREIGN KEY (degrees_id, educations_id, function_id, ranks_id, regions_id) REFERENCES sozd.nsi_function (id);
ALTER TABLE sozd.rel_deputies_function_function ADD CONSTRAINT deputies_fk_1 FOREIGN KEY (degrees_id, educations_id, function_id, ranks_id, regions_id) REFERENCES sozd.nsi_ranks (id);
ALTER TABLE sozd.rel_deputies_function_function ADD CONSTRAINT deputies_fk_1 FOREIGN KEY (degrees_id, educations_id, function_id, ranks_id, regions_id) REFERENCES sozd.nsi_regions (id);
ALTER TABLE sozd.rel_deputies_ranks_rank ADD CONSTRAINT deputies_fk FOREIGN KEY (deputies_id) REFERENCES sozd.nsi_deputies (id);
ALTER TABLE sozd.rel_deputies_ranks_rank ADD CONSTRAINT deputies_fk_1 FOREIGN KEY (degrees_id, educations_id, function_id, ranks_id, regions_id) REFERENCES sozd.nsi_degrees (id);
ALTER TABLE sozd.rel_deputies_ranks_rank ADD CONSTRAINT deputies_fk_1 FOREIGN KEY (degrees_id, educations_id, function_id, ranks_id, regions_id) REFERENCES sozd.nsi_educations (id);
ALTER TABLE sozd.rel_deputies_ranks_rank ADD CONSTRAINT deputies_fk_1 FOREIGN KEY (degrees_id, educations_id, function_id, ranks_id, regions_id) REFERENCES sozd.nsi_function (id);
ALTER TABLE sozd.rel_deputies_ranks_rank ADD CONSTRAINT deputies_fk_1 FOREIGN KEY (degrees_id, educations_id, function_id, ranks_id, regions_id) REFERENCES sozd.nsi_ranks (id);
ALTER TABLE sozd.rel_deputies_ranks_rank ADD CONSTRAINT deputies_fk_1 FOREIGN KEY (degrees_id, educations_id, function_id, ranks_id, regions_id) REFERENCES sozd.nsi_regions (id);
ALTER TABLE sozd.rel_deputies_regions_region ADD CONSTRAINT deputies_fk FOREIGN KEY (deputies_id) REFERENCES sozd.nsi_deputies (id);
ALTER TABLE sozd.rel_deputies_regions_region ADD CONSTRAINT deputies_fk_1 FOREIGN KEY (degrees_id, educations_id, function_id, ranks_id, regions_id) REFERENCES sozd.nsi_degrees (id);
ALTER TABLE sozd.rel_deputies_regions_region ADD CONSTRAINT deputies_fk_1 FOREIGN KEY (degrees_id, educations_id, function_id, ranks_id, regions_id) REFERENCES sozd.nsi_educations (id);
ALTER TABLE sozd.rel_deputies_regions_region ADD CONSTRAINT deputies_fk_1 FOREIGN KEY (degrees_id, educations_id, function_id, ranks_id, regions_id) REFERENCES sozd.nsi_function (id);
ALTER TABLE sozd.rel_deputies_regions_region ADD CONSTRAINT deputies_fk_1 FOREIGN KEY (degrees_id, educations_id, function_id, ranks_id, regions_id) REFERENCES sozd.nsi_ranks (id);
ALTER TABLE sozd.rel_deputies_regions_region ADD CONSTRAINT deputies_fk_1 FOREIGN KEY (degrees_id, educations_id, function_id, ranks_id, regions_id) REFERENCES sozd.nsi_regions (id);
ALTER TABLE sozd.rel_law_themes_list_laws_themes_laws ADD CONSTRAINT law_themes_fk FOREIGN KEY (law_themes_id) REFERENCES sozd.nsi_law_themes (id);
ALTER TABLE sozd.rel_law_themes_list_laws_themes_laws ADD CONSTRAINT law_themes_fk_1 FOREIGN KEY (list_laws_themes_id) REFERENCES sozd.nsi_list_laws_themes (id);
ALTER TABLE sozd.rel_stages_phases_phase ADD CONSTRAINT stages_fk FOREIGN KEY (stages_id) REFERENCES sozd.nsi_stages (id);
ALTER TABLE sozd.rel_stages_phases_phase ADD CONSTRAINT stages_fk_1 FOREIGN KEY (phases_id) REFERENCES sozd.nsi_phases (id);
ALTER TABLE sozd.request_amendments ADD CONSTRAINT request_amendments_fk FOREIGN KEY (law_id) REFERENCES sozd.url_id (law_id);
ALTER TABLE sozd.trans_data ADD CONSTRAINT trans_data_fk FOREIGN KEY (law_id) REFERENCES sozd.url_id (law_id);