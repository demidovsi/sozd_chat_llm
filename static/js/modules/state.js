...
const SCHEMA_EXAMPLES = {
  ...
  family: {
    sql: {
      text: [
        '"Покажи расходы в группе 14"',
        '"Найди события с указанием \'врач\'"',
        '"Cколько у нас сейчас денег"',
        '"сколько у нас сейчас денег. Для валют отличных от шекеля укажи еще и их эквивалент в шекелях и добавь окончательную сумму в шекелях"'
      ],
      date: [
        '"Покажи расходы в декабре 2025"',
        '"Найди события после 2025 года"',
        '"Выведи среднесуточную температуру в здании 1 за декабрь 2025"'
      ],
      stats: [
        '"Найди события с указанием \'прогулка\' и выдели в событии длину прогулки как число (возможно с о знаком после точки) перед словом \'км\'"',
        '"Пподсчитай сумму длин \'прогулка\' . В событии длина прогулки это число (возможно с о знаком после точки) перед словом \'км\'."'
      ],
      complex: [
        'за каждые сутки декабря 2025 дай среднесуточную температуру в зданиях 1 и 2 в отдельных колонках'
      ]
    },
    custom: {
      semantic: [
...
❗Если нужно получить весь список (а не 10 строк) — добавьте в запрос "без лимита" или укажите нужное количество строк.
❗❗Имейте ввиду, что запрос без лимита может занять больше времени на выполнение и на вывод информации.
