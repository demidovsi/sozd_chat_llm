...
/**
 * Примеры запросов для каждой схемы БД
 */
const SCHEMA_EXAMPLES = {
  ...
  lib: {
    sql: {
      text: [
        '"Покажи все книги Достоевского"',
        '"Найди произведения содержащие слово \'любовь\'"'
      ],
      date: [
        '"Покажи книги изданные в 19 веке"',
        '"Найди произведения опубликованные после 1900 года"'
      ],
      stats: [
        '"Посчитай количество книг по авторам"',
        '"Покажи топ 10 самых популярных жанров"'
      ],
      complex: [
        '"Найди все романы о войне изданные в 20 веке и отсортируй по автору"'
      ]
    },
    custom: {
      semantic: [
        '"Расскажи о творчестве Гаазе"',
        '"Какие книги посвящены благотворительности?"'
      ],
      topics: [
        '"Найди произведения о медицине в России"',
        '"Что писали о тюремной реформе?"'
      ],
      specific: [
        '"Когда Гаазе начал свою деятельность?"',
        '"Какие награды получил Гаазе?"'
      ],
      analytics: [
        '"Сравни подходы к благотворительности в разные эпохи"'
      ]
    }
  },
  family: {
    sql: {
      text: [
        '"Покажи всех членов семьи с фамилией Иванов"',
        '"Найди записи содержащие имя \'Мария\'"'
      ],
      date: [
        '"Покажи людей родившихся в 1980 году"',
        '"Найди события после 2000 года"'
      ],
      stats: [
        '"Посчитай количество людей по поколениям"',
        '"Покажи топ 10 самых популярных имен"'
      ],
      complex: [
        '"Найди всех родственников старше 50 лет и отсортируй по дате рождения"'
      ]
    },
    custom: {
      semantic: [
        '"Расскажи о семейных традициях"',
        '"Какие события важны для семьи?"'
      ],
      topics: [
        '"Найди информацию о предках из Москвы"',
        '"Что известно о военных годах?"'
      ],
      specific: [
        '"Когда родился прадед Иван?"',
        '"Какие профессии были в семье?"'
      ],
      analytics: [
        '"Как менялась география проживания семьи?"'
      ]
    }
  },
  urban: {
    sql: {
      text: [
        '"Покажи все локации с типом \'парк\'"',
        '"Найди объекты содержащие слово \'площадь\'"'
      ],
      date: [
        '"Покажи здания построенные в 2020 году"',
        '"Найди события после 1 января 2023"'
      ],
      stats: [
        '"Посчитай количество объектов по районам"',
        '"Покажи топ 10 самых посещаемых мест"'
      ],
      complex: [
        '"Найди все памятники в центре построенные до 1917 года и отсортируй по дате"'
      ]
    },
    custom: {
      semantic: [
        '"Расскажи об истории этого района"',
        '"Какие достопримечательности есть поблизости?"'
      ],
      topics: [
        '"Найди информацию о культурных центрах"',
        '"Что интересного в этом квартале?"'
      ],
      specific: [
        '"Когда построили это здание?"',
        '"Какие события проходят в парке?"'
      ],
      analytics: [
        '"Как менялся городской ландшафт за последние годы?"'
      ]
    }
  },
  eco: {
    sql: {
      text: [
        '"Покажи все данные о загрязнении воздуха"',
        '"Найди записи содержащие \'заповедник\'"'
      ],
      date: [
        '"Покажи измерения за 2023 год"',
        '"Найди данные после 1 января 2024"'
      ],
      stats: [
        '"Посчитай среднюю температуру по месяцам"',
        '"Покажи топ 10 самых загрязненных районов"'
      ],
      complex: [
        '"Найди все измерения CO2 выше нормы за последний год и отсортируй по дате"'
      ]
    },
    custom: {
      semantic: [
        '"Как изменился климат в регионе?"',
        '"Расскажи о состоянии экосистемы"'
      ],
      topics: [
        '"Какие виды животных под угрозой?"',
        '"Что делается для охраны природы?"'
      ],
      specific: [
        '"Какой уровень загрязнения сегодня?"',
        '"Сколько заповедников в регионе?"'
      ],
      analytics: [
        '"Сравни экологическую ситуацию за разные годы"'
      ]
    }
  },
  gen: {
    sql: {
      text: [
        '"Покажи все записи о событиях"',
        '"Найди документы содержащие слово \'встреча\'"'
      ],
      date: [
        '"Покажи записи за 2023 год"',
        '"Найди события после 1 января 2024"'
      ],
      stats: [
        '"Посчитай количество записей по категориям"',
        '"Покажи топ 10 самых частых тем"'
      ],
      complex: [
        '"Найди все важные события за последний месяц и отсортируй по дате"'
      ]
    },
    custom: {
      semantic: [
        '"Расскажи о важных моментах"',
      ...
      specific: [
        ...
        '"Какие достижения есть?"'
      ],
      analytics: [
        '"Как менялись приоритеты со временем?"'
      ]
    }
  },
  ohi: {
    sql: {
      text: [
        '"Покажи всех участников программы"',
        '"Найди записи содержащие \'репатриация\'"'
      ],
      date: [
        '"Покажи заявки поданные в 2023 году"',
        '"Найди документы после 1 января 2024"'
      ],
      stats: [
        '"Посчитай количество участников по странам"',
        '"Покажи топ 10 самых популярных программ"'
      ],
      complex: [
        '"Найди всех участников из России принятых в программу в 2024 году и отсортируй по дате"'
      ]
    },
    custom: {
      semantic: [
        '"Как проходит процесс репатриации?"',
        '"Расскажи о программах поддержки"'
      ],
      topics: [
        '"Какие документы нужны для переезда?"',
        '"Что предлагается новым репатриантам?"'
      ],
      specific: [
        '"Сколько длится процесс одобрения?"',
        '"Какая помощь доступна семьям?"'
      ],
      analytics: [
        '"Сравни количество репатриантов за разные годы"'
      ]
    }
  }
};
...
export function getWelcomeMessage(modeConfig, schemaValue) {
  ...
  const examples = SCHEMA_EXAMPLES[schemaValue] || SCHEMA_EXAMPLES.sozd; // Fallback на примеры sozd
